function checkboxSetup(){
	...
	sliderIntroText.position(iroPickerDiv.x, iroPickerDiv.y + parseFloat(iroPickerDiv.style('height')) + 20);	
...
function resetCheckboxes(){
	...
	puntoCheckbox.position(iroPickerDiv.x, sliderIntroText.y + 40);	// this position here controls all the checkbox / sliders' position relative this this
